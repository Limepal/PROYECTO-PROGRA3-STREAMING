...
private:
    ...
    vector<unique_ptr<IInteraccionObserver>> observadores;

    void registrarObserver(unique_ptr<IInteraccionObserver> observer);
    void notificarInteraccion(int id, const string& accion);
